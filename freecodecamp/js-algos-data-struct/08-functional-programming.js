...
var ratings = watchList.map(movie => {
  ...
  diMovies['title'] = movie['Title'];
  diMovies['rating'] = movie['imdbRating'];
...
/ ** Functional Programming: Implement map on a Prototype
  *  JavaScript callback is a function `a` that is provided as input to another function `b`,
  *  then called inside the definition of function `b`
  *  this.forEach();
  */
...
/ ** Functional Programming: Use the filter Method to Extract Data from an Array
  ...
  *  In JavaScript, it's ok to add line breaks and spaces in between the methods, ignores indentation too
  */
...
var filteredList = watchList
  ...
  .map(movie => {
    ...
    diMovie['title'] = movie['Title'];
    diMovie['rating'] = movie['imdbRating'];
